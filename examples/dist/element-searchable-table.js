...
var elementSearchableTable = function (_LEOElement) {
	_inherits(elementSearchableTable, _LEOElement);

	function elementSearchableTable() {
		_classCallCheck(this, elementSearchableTable);

		return _possibleConstructorReturn(this, (elementSearchableTable.__proto__ || Object.getPrototypeOf(elementSearchableTable)).apply(this, arguments));
	}

	_createClass(elementSearchableTable, [{
		key: 'onKeyup',
		value: function onKeyup(e) {
			var query = e.target.value;
			if (query) {
				this.data.users = _users2.default.filter(function (item) {
