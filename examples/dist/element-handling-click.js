...
var elementHandlingClick = function (_LEOElement) {
	_inherits(elementHandlingClick, _LEOElement);

	function elementHandlingClick() {
		_classCallCheck(this, elementHandlingClick);

		return _possibleConstructorReturn(this, (elementHandlingClick.__proto__ || Object.getPrototypeOf(elementHandlingClick)).apply(this, arguments));
	}

	_createClass(elementHandlingClick, [{
		key: 'onClick',
