...
var elementReactiveInput = function (_LEOElement) {
	_inherits(elementReactiveInput, _LEOElement);

	function elementReactiveInput() {
		_classCallCheck(this, elementReactiveInput);

		return _possibleConstructorReturn(this, (elementReactiveInput.__proto__ || Object.getPrototypeOf(elementReactiveInput)).apply(this, arguments));
	}

	_createClass(elementReactiveInput, [{
		key: 'onKeyup',
